  ...
  while (!v1.empty()) {
    ...
    if (v2.size() < number) {
      ...
      if (it2 != v2.end()) {
        ...
        vector<int> v4;
        for (int i = 0; i < number; ++i) {
          if (v3[i] == v3[j]) v4.push_back(i);
        }
        int max = v4[0];
        for (int i = 0; i < v4.size(); ++i) {
          if (v2[v4[i]].second > v2[max].second) max = i;
        }
        it1 = v1.begin();
        v2[max].first = *it1;
        v2[max].second = 0;
  ...
  while (!v1.empty()) {
    ...
    if (v2.size() < number) {
      ...
      if (it2 != v2.end()) {
        ...
        v2.push_back(pair<int, int>(*it1, 0));
        cout << *it1 << ',';
        for (int i = 0; i < number - v2.size(); ++i) cout << "-,";
        if (v1.size() == 1)
          cout << '0' << endl;
        else
          cout << "0/";
      ...
      if (it2 != v2.end()) {
        ...
        for (it2 = v2.begin(); it2 != v2.end(); it2++) {
          if (it2->second > it3->second) it3 = it2;
        }
        it3->first = *it1;
        it3->second = 0;
        for (it2 = v2.begin(); it2 != v2.end(); it2++) {
